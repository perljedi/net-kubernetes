...
describe "Net::Kubernetes - Namespace" => sub {
	...
	describe "get_pod" => sub {
		...
		it "returns a Net::Kubernetes::Resource::Pod object on success" => sub {
			spyOn('LWP::UserAgent', 'request')->andReturn(HTTP::Response->new(200, "ok", undef, '{"spec":{}, "metadata":{"selfLink":"/path/to/me"}, "status":{}, "kind":"Pod", "apiVersion":"v1beta3"}'));
			my $pod;
	...
	describe "get_rc" => sub {
		...
		it "returns a Net::Kubernetes::Resource::ReplicationController object on success" => sub {
			spyOn('LWP::UserAgent', 'request')->andReturn(HTTP::Response->new(200, "ok", undef, '{"spec":{}, "metadata":{"selfLink":"/path/to/me"}, "status":{}, "kind":"ReplicationController", "apiVersion":"v1beta3"}'));
			my $rc;
	...
	describe "get_service" => sub {
		...
		it "returns a Net::Kubernetes::Resource::Service object on success" => sub {
			spyOn('LWP::UserAgent', 'request')->andReturn(HTTP::Response->new(200, "ok", undef, '{"spec":{}, "metadata":{"selfLink":"/path/to/me"}, "status":{}, "kind":"Service", "apiVersion":"v1beta3"}'));
			my $se;
	...
	describe "get_secret" => sub {
		...
		it "returns a Net::Kubernetes::Resource::Secret object on success" => sub {
			spyOn('LWP::UserAgent', 'request')->andReturn(HTTP::Response->new(200, "ok", undef, '{"type":"hiddeen", "metadata":{"selfLink":"/path/to/me"}, "data":{"stuff":"here"}, "kind":"Secret", "apiVersion":"v1beta3"}'));
			my $secret;
